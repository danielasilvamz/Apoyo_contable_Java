...
public class Multiplicacion {
    ...
    //creacion del metodo multiplicacion:
    /* Para usarlo otra clase (ApoyoContable) debe colocar su nombre (multiplicacion) y pasarle los valores
    ...
    public float multiplicacion(int producto1, int producto2, double producto3, double producto4, double producto5)
    {
        //se realiza la operación y se realiza el casting para entregar el dato como float
        multiplicacionProductos = (float) (producto1 * producto2 * producto3 * producto4 * producto5);
        //se retorna
        return multiplicacionProductos;
    }   
}
